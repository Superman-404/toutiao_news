...
class Category(Base):
    ...
    def __repr__(
        ...
        return (f"<Category(id={self.name}, name={self.name}, sort_order="
                f"{self.sort_order})>")
...
class News(Base):
    ...
    # 创建索引:提升查询速度 -> 添加目录
    __table_args__ = (Index("fk_news_category_idx",
                            "category_id"),  # id高频查询
    ...
    def __repr__(
        ...
        return f"<News(id={self.id},title={self.title},view={self.views})>"
